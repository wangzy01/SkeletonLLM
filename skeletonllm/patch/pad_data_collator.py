    ...
    for k, v in first.items():
        ...
        if k in ('pixel_values', 'image_flags'):
            if isinstance(v, torch.Tensor):
                ...
                # Support non-tensor pixel_values (e.g., list[str] skeleton paths)
                # For image_flags we still expect tensors; this branch mainly handles pixel_values as Python objects
                if k == 'pixel_values':
