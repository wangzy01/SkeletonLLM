...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        self.skeleton_num_line_samples = int(skeleton_num_line_samples)
        self.skeleton_target_num_frames = int(skeleton_target_num_frames)
        self.skeleton_fovx_deg = float(skeleton_fovx_deg)
    ...
    def to_dict(self):
        ...
        output['use_skeleton'] = self.use_skeleton
        output['skeleton_num_line_samples'] = self.skeleton_num_line_samples
        output['skeleton_target_num_frames'] = self.skeleton_target_num_frames
        output['skeleton_fovx_deg'] = self.skeleton_fovx_deg
